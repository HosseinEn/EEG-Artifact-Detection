...
class DataNoiseCombiner:
    def __init__(self, config):
        ...
        self.data_clean = self.augment_data(self.data_clean, 4)
        self.data_eog = self.augment_data(self.data_eog, 4)
        self.data_emg = self.augment_data(self.data_emg, 4)
        self.white_noise = self.augment_data(self.white_noise, 4)
    ...
    def augment_data(self, data, num_samples):
        d = np.repeat(data[0], num_samples, axis=0)
        l = np.repeat(data[1], num_samples, axis=0)
        return d, l
